...
/**
 * updates all possible movements for rook based on its king position and board state
 * @param king
 * @param board
 ...
 * @param changeLetPos
 */
void Rook::getMove(King * king, Board * board, vector<FieldToMove> & fullRangeOfMoves, const int & changeNumPos, const int & changeLetPos) {
...
/**
 * returns all possible moves for rook based on current state of board and its king position
 * @param king
 * @param board
 * @return
 */
vector < FieldToMove > Rook::getFullRangeOfMoves(King * king, Board * board) {
